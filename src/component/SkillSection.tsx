...
const skillIcons: Record<string, React.ReactNode> = {
  "TypeScript": (
    <svg className="w-5 h-5 shrink-0 rounded" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const getSkillIcon = (skill: string) => {
  return skillIcons[skill] || (
    <svg className="w-5 h-5 shrink-0 text-slate-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <section id="skills" className={`relative min-h-screen py-12 sm:py-16 md:py-20 px-4 md:px-6 ${
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4 md:mb-6 bg-gradient-to-r from-green-500 to-teal-500 bg-clip-text text-transparent font-bold tracking-tight">
            Skills & Activity
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
            ...
            {skillCategories.map((category, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className={`p-6 md:p-8 rounded-3xl border backdrop-blur-sm shadow-lg transition-all duration-300 group ${
                    isDark 
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className={`text-sm mt-1 transition-colors ${isDark ? 'text-slate-400 group-hover:text-slate-350' : 'text-slate-650 group-hover:text-slate-750'}`}>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {category.skills.map((skill) => (
                      <motion.button
                        ...
                        className={`px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl text-xs sm:text-sm font-medium border transition-all ${
                          isDark 
                        ...
                        } shadow-sm cursor-pointer flex items-center gap-2.5`}
                      >
                        {getSkillIcon(skill)}
                        <span>{skill}</span>
                      </motion.button>
          ...
          <div className="lg:col-span-4 flex flex-col">
            ...
            >
              <GitHubActivity isDark={isDark} username={import.meta.env.VITE_GITHUB_USERNAME || 'CodeBlue0001'} />
            </motion.div>
          </div>
        </div>
      </div>
