  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className={`hidden md:flex fixed top-6 left-1/2 -translate-x-1/2 z-50 gap-2 backdrop-blur-md ${
          isDark 
      ...
      <motion.button
        ...
        className={`md:hidden fixed top-6 left-6 z-50 p-3 rounded-full backdrop-blur-md ${
          isDark 
      ...
      <motion.div
        ...
        className={`md:hidden fixed top-20 left-6 z-40 backdrop-blur-md ${
          isDark 
        ...
        <div className="flex flex-col p-2">
          {navItems.map((item) => (
            <motion.button
              ...
              className={`px-6 py-3 rounded-lg text-left transition-all font-medium border ${
                activeSection === item.id
                  ? isDark
          ...
          <motion.a
            ...
            className={`px-6 py-3 rounded-lg text-left transition-all font-medium border flex items-center justify-between ${
              isDark 
